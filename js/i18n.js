const translations = {
  es: {
    ...
    quiz: {
      ...
      intro_desc: "Hemos analizado más de 150 modelos para ayudarte a decidir.",
      btn_start: "Comenzar Cuestionario",
      q1_title: "1. ¿Cuál será el uso principal?",
      q1_opt1: "Gaming y Uso Diario",
      q1_opt2: "Trabajo Pro / Render / IA",
      q1_opt3: "Gaming en Portátil",
      q2_title: "2. ¿Cuál es tu presupuesto aproximado?",
      q2_opt1: "Económico (Menos de $400)",
      q2_opt2: "Medio ($400 - $900)",
      q2_opt3: "Alto / Premium (+$900)",
      q3_title: "3. ¿Qué resolución o carga de trabajo buscas?",
      q3_opt1: "1080p / Trabajo Ligero",
      q3_opt2: "1440p / Trabajo Moderado",
      q3_opt3: "4K / Render Pesado / IA",
      results_title: "Nuestras recomendaciones",
    ...
    hero: {
      ...
      btn_primary: "Explorar GPUs",
      btn_ghost: "Comparar Modelos",
      stats_models: "Modelos",
      stats_vram: "VRAM Máx",
      stats_top: "Top Server",
    ...
    categories: {
      ...
      gaming_tag: "Doméstica",
      work_title: "Workstation",
      work_desc: "NVIDIA Quadro / RTX Pro / AMD Pro",
    ...
    catalog: {
      ...
      era: "Lanzamiento",
      sort_value: "Rendimiento/precio",
      filters_toggle: "Filtros",
      reset: "Restablecer",
      showing: "Mostrando <strong>{shown}</strong> de <strong>{total}</strong> GPUs",
      load_more: "Ver más GPUs",
      remaining: "{n} restantes",
      no_results: "Ninguna GPU coincide con estos filtros",
      no_results_hint: "Prueba con otra búsqueda o restablece los filtros.",
      view_details: "Detalles",
      perf_index: "Índice gaming",
      perf_index_def: "<strong>Índice gaming</strong>: estimación del rendimiento medio en juegos (1440p/4K) respecto a la RTX 5090 = 100, a partir de análisis publicados. Es orientativo.",
      perf_index_laptop_def: "<strong>Índice gaming</strong>: rendimiento relativo entre GPUs de portátil (la más potente = 100). Varía mucho según el TGP de cada equipo.",
      perf_rank: "Puesto <strong>#{rank}</strong> de {total} en rendimiento",
      similar: "Alternativas con rendimiento similar",
      compare: "Comparar",
      close: "Cerrar",
    ...
    gaming_page: {
      ...
      stat_laptop: "De portátil",
      stat_years: "Años cubiertos",
  ...
  en: {
    ...
    quiz: {
      ...
      intro_desc: "We have analyzed over 150 models to help you decide.",
      btn_start: "Start Quiz",
      q1_title: "1. What will be the primary use?",
      q1_opt1: "Gaming and Daily Use",
      q1_opt2: "Pro Work / Render / AI",
      q1_opt3: "Laptop Gaming",
      q2_title: "2. What is your approximate budget?",
      q2_opt1: "Budget (Under $400)",
      q2_opt2: "Mid-Range ($400 - $900)",
      q2_opt3: "High / Premium (+$900)",
      q3_title: "3. What resolution or workload are you looking for?",
      q3_opt1: "1080p / Light Workload",
      q3_opt2: "1440p / Moderate Workload",
      q3_opt3: "4K / Heavy Render / AI",
      results_title: "Our recommendations",
    ...
    hero: {
      ...
      btn_primary: "Explore GPUs",
      btn_ghost: "Compare Models",
      stats_models: "Models",
      stats_vram: "Max VRAM",
      stats_top: "Top Server",
    ...
    catalog: {
      ...
      era: "Release",
      sort_value: "Perf/price",
      filters_toggle: "Filters",
      reset: "Reset",
      showing: "Showing <strong>{shown}</strong> of <strong>{total}</strong> GPUs",
      load_more: "Show more GPUs",
      remaining: "{n} left",
      no_results: "No GPU matches these filters",
      no_results_hint: "Try another search or reset the filters.",
      view_details: "Details",
      perf_index: "Gaming index",
      perf_index_def: "<strong>Gaming index</strong>: estimated average gaming performance (1440p/4K) relative to the RTX 5090 = 100, based on published reviews. Indicative only.",
      perf_index_laptop_def: "<strong>Gaming index</strong>: relative performance among laptop GPUs (fastest = 100). Varies a lot with each laptop's TGP.",
      perf_rank: "Ranked <strong>#{rank}</strong> of {total} in performance",
      similar: "Alternatives with similar performance",
      compare: "Compare",
      close: "Close",
  ...
  fr: {
    ...
    quiz: {
      ...
      intro_desc: "Nous avons analysé plus de 150 modèles pour vous aider à décider.",
      btn_start: "Commencer le Quiz",
      q1_title: "1. Quelle sera l'utilisation principale ?",
      q1_opt1: "Jeu et utilisation quotidienne",
      q1_opt2: "Travail Pro / Rendu / IA",
      q1_opt3: "Jeu sur PC portable",
      q2_title: "2. Quel est votre budget approximatif ?",
      q2_opt1: "Économique (Moins de 400 €)",
      q2_opt2: "Moyen (400 € - 900 €)",
      q2_opt3: "Haut de gamme (+900 €)",
      q3_title: "3. Quelle résolution ou charge de travail recherchez-vous ?",
      q3_opt1: "1080p / Travail léger",
      q3_opt2: "1440p / Travail modéré",
      q3_opt3: "4K / Rendu lourd / IA",
      results_title: "Nos recommandations",
    ...
    hero: {
      ...
      btn_primary: "Explorer les GPUs",
      btn_ghost: "Comparer les Modèles",
    ...
    categories: {
      gaming_title: "Jeu",
      gaming_desc: "De la GTX 460 à la RTX 5090",
      gaming_tag: "Domestique",
      work_title: "Station de Travail",
      work_desc: "NVIDIA Quadro / RTX Pro / AMD Pro",
    ...
    catalog: {
      ...
      era: "Sortie",
      sort_value: "Perf./prix",
      filters_toggle: "Filtres",
      reset: "Réinitialiser",
      showing: "<strong>{shown}</strong> GPU affichés sur <strong>{total}</strong>",
      load_more: "Voir plus de GPU",
      remaining: "{n} restants",
      no_results: "Aucun GPU ne correspond à ces filtres",
      no_results_hint: "Essayez une autre recherche ou réinitialisez les filtres.",
      view_details: "Détails",
      perf_index: "Indice gaming",
      perf_index_def: "<strong>Indice gaming</strong> : estimation des performances moyennes en jeu (1440p/4K) par rapport à la RTX 5090 = 100, d'après des tests publiés. Valeur indicative.",
      perf_index_laptop_def: "<strong>Indice gaming</strong> : performances relatives entre GPU pour portables (le plus puissant = 100). Varie beaucoup selon le TGP de chaque machine.",
      perf_rank: "<strong>#{rank}</strong> sur {total} en performances",
      similar: "Alternatives aux performances similaires",
      compare: "Comparer",
      close: "Fermer",
  ...
  de: {
    ...
    quiz: {
      ...
      intro_desc: "Wir haben über 150 Modelle analysiert, um Ihnen bei der Entscheidung zu helfen.",
      btn_start: "Quiz Starten",
      q1_title: "1. Was wird die Hauptverwendung sein?",
      q1_opt1: "Gaming und täglicher Gebrauch",
      q1_opt2: "Profi-Arbeit / Rendern / KI",
      q1_opt3: "Laptop-Gaming",
      q2_title: "2. Wie hoch ist Ihr ungefähres Budget?",
      q2_opt1: "Günstig (Unter 400 €)",
      q2_opt2: "Mittel (400 € - 900 €)",
      q2_opt3: "Premium (+900 €)",
      q3_title: "3. Welche Auflösung oder Arbeitslast suchen Sie?",
      q3_opt1: "1080p / Leichte Arbeit",
      q3_opt2: "1440p / Mittlere Arbeit",
      q3_opt3: "4K / Schweres Rendern / KI",
      results_title: "Unsere Empfehlungen",
    ...
    hero: {
      ...
      btn_primary: "GPUs entdecken",
      btn_ghost: "Modelle vergleichen",
    ...
    catalog: {
      ...
      era: "Erscheinungsjahr",
      sort_value: "Leistung/Preis",
      filters_toggle: "Filter",
      reset: "Zurücksetzen",
      showing: "<strong>{shown}</strong> von <strong>{total}</strong> GPUs",
      load_more: "Mehr GPUs anzeigen",
      remaining: "noch {n}",
      no_results: "Keine GPU entspricht diesen Filtern",
      no_results_hint: "Versuche eine andere Suche oder setze die Filter zurück.",
      view_details: "Details",
      perf_index: "Gaming-Index",
      perf_index_def: "<strong>Gaming-Index</strong>: geschätzte durchschnittliche Spieleleistung (1440p/4K) relativ zur RTX 5090 = 100, basierend auf veröffentlichten Tests. Nur ein Richtwert.",
      perf_index_laptop_def: "<strong>Gaming-Index</strong>: relative Leistung unter Laptop-GPUs (schnellste = 100). Hängt stark von der TGP des jeweiligen Geräts ab.",
      perf_rank: "Platz <strong>#{rank}</strong> von {total} bei der Leistung",
      similar: "Alternativen mit ähnlicher Leistung",
      compare: "Vergleichen",
      close: "Schließen",
  ...
  it: {
    ...
    quiz: {
      ...
      intro_desc: "Abbiamo analizzato più di 150 modelli per aiutarti a decidere.",
      btn_start: "Inizia Quiz",
      q1_title: "1. Quale sarà l'utilizzo principale?",
      q1_opt1: "Gaming e Uso Quotidiano",
      q1_opt2: "Lavoro Pro / Render / IA",
      q1_opt3: "Gaming su Laptop",
      q2_title: "2. Qual è il tuo budget approssimativo?",
      q2_opt1: "Economico (Meno di 400 €)",
      q2_opt2: "Medio (400 € - 900 €)",
      q2_opt3: "Alto / Premium (+900 €)",
      q3_title: "3. Che risoluzione o carico di lavoro cerchi?",
      q3_opt1: "1080p / Lavoro Leggero",
      q3_opt2: "1440p / Lavoro Moderato",
      q3_opt3: "4K / Render Pesante / IA",
      results_title: "Le nostre raccomandazioni",
    ...
    hero: {
      ...
      btn_primary: "Esplora GPU",
      btn_ghost: "Confronta Modelli",
      stats_models: "Modelli",
      stats_vram: "VRAM Max",
      stats_top: "Top Server",
    ...
    catalog: {
      ...
      era: "Uscita",
      sort_value: "Prestazioni/prezzo",
      filters_toggle: "Filtri",
      reset: "Reimposta",
      showing: "<strong>{shown}</strong> GPU su <strong>{total}</strong>",
      load_more: "Mostra altre GPU",
      remaining: "altre {n}",
      no_results: "Nessuna GPU corrisponde a questi filtri",
      no_results_hint: "Prova un'altra ricerca o reimposta i filtri.",
      view_details: "Dettagli",
      perf_index: "Indice gaming",
      perf_index_def: "<strong>Indice gaming</strong>: stima delle prestazioni medie nei giochi (1440p/4K) rispetto alla RTX 5090 = 100, basata su recensioni pubblicate. Solo indicativo.",
      perf_index_laptop_def: "<strong>Indice gaming</strong>: prestazioni relative tra GPU per portatili (la più potente = 100). Varia molto in base al TGP di ogni modello.",
      perf_rank: "<strong>#{rank}</strong> su {total} per prestazioni",
      similar: "Alternative con prestazioni simili",
      compare: "Confronta",
      close: "Chiudi",
    ...
    gaming_page: {
      ...
      stat_desktop: "Desktop",
      stat_laptop: "Portatili",
      stat_years: "Anni coperti",
  ...
  ru: {
    ...
    quiz: {
      ...
      intro_desc: "Мы проанализировали более 150 моделей, чтобы помочь вам решить.",
      btn_start: "Начать викторину",
      q1_title: "1. Каково основное использование?",
      q1_opt1: "Игры и повседневное использование",
      q1_opt2: "Проф. работа / Рендеринг / ИИ",
      q1_opt3: "Игры на ноутбуке",
      q2_title: "2. Каков ваш примерный бюджет?",
      q2_opt1: "Бюджетный (Менее 400 ₽)",
      q2_opt2: "Средний (400 ₽ - 900 ₽)",
      q2_opt3: "Премиум (+900 ₽)",
      q3_title: "3. Какое разрешение или нагрузку вы ищете?",
      q3_opt1: "1080p / Легкая работа",
      q3_opt2: "1440p / Умеренная работа",
      q3_opt3: "4K / Тяжелый рендеринг / ИИ",
      results_title: "Наши рекомендации",
    ...
    hero: {
      ...
      btn_primary: "Смотреть GPU",
      btn_ghost: "Сравнить модели",
      stats_models: "Моделей",
      stats_vram: "Макс VRAM",
    ...
    categories: {
      gaming_title: "Игры",
      gaming_desc: "От GTX 460 до RTX 5090",
      gaming_tag: "Домашние",
    ...
    catalog: {
      ...
      era: "Год выхода",
      sort_value: "Произв./цена",
      filters_toggle: "Фильтры",
      reset: "Сбросить",
      showing: "Показано <strong>{shown}</strong> из <strong>{total}</strong> GPU",
      load_more: "Показать ещё",
      remaining: "осталось {n}",
      no_results: "Нет GPU, подходящих под эти фильтры",
      no_results_hint: "Попробуйте другой запрос или сбросьте фильтры.",
      view_details: "Подробнее",
      perf_index: "Игровой индекс",
      perf_index_def: "<strong>Игровой индекс</strong>: примерная средняя производительность в играх (1440p/4K) относительно RTX 5090 = 100 по данным опубликованных обзоров. Носит ориентировочный характер.",
      perf_index_laptop_def: "<strong>Игровой индекс</strong>: относительная производительность мобильных GPU (самая мощная = 100). Сильно зависит от TGP конкретного ноутбука.",
      perf_rank: "<strong>#{rank}</strong> из {total} по производительности",
      similar: "Альтернативы с похожей производительностью",
      compare: "Сравнить",
      close: "Закрыть",
      back_to_top: "Наверх",
    ...
    gaming_page: {
      ...
      stat_laptop: "Мобильных",
      stat_years: "Охваченные годы",
