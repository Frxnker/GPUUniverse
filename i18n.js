const translations = {
  es: {
    ...
    sections: {
      ...
      mobile_label: "💻 Móvil / Portátil",
      mobile_title: "GPUs",
      mobile_title_hl: "para Laptops",
      mobile_p: "Tarjetas gráficas de alto rendimiento optimizadas para portátiles y dispositivos móviles",
  ...
  en: {
    ...
    sections: {
      ...
      mobile_label: "💻 Mobile / Laptop",
      mobile_title: "Laptop",
      mobile_title_hl: "GPUs",
      mobile_p: "High-performance graphics cards optimized for laptops and mobile devices",
  ...
  fr: {
    ...
    sections: {
      ...
      mobile_label: "💻 Mobile / Portable",
      mobile_title: "GPUs",
      mobile_title_hl: "pour Portables",
      mobile_p: "Cartes graphiques hautes performances optimisées pour les ordinateurs portables et les appareils mobiles",
  ...
  de: {
    ...
    sections: {
      ...
      mobile_title: "Laptop",
      mobile_title_hl: "GPUs",
      mobile_p: "Leistungsstarke Grafikkarten optimiert für Laptops und mobile Geräte",
  ...
  it: {
    ...
    sections: {
      ...
      mobile_p: "Schede grafiche ad alte prestazioni ottimizzate per laptop e dispositivi mobili",
  ...
  ru: {
    ...
    sections: {
      ...
      mobile_p: "Высокопроизводительные видеокарты, оптимизированные для ноутбуков и мобильных устройств",
